...
const allMeetings = [
  ...
  },
  {
    ...
    id: '2026-03-24',
    date: 'March 24, 2026',
    time: '9:00 AM (Exec) / 1:00 PM (Regular)',
    location: 'Denver Federal Center, Lakewood, CO OR Virtual via Teams',
    type: 'STC Meeting (Regular + Executive)',
    status: 'completed',
    calDay: 24,
    summary: 'Ebright CRP appeal hearing (E2, 90 min, Bent County, 7 contracts — guests John & Stephanie Ebright plus POA Kris Demoss). Payne Legacy LLC CRP payment-reduction waiver (E5, El Paso County). Not-for-NAP Prevent Plant reaffirmation and Otero County applications (Day, Bender). 2026 NCT Colorado action on 21 specialty crops. Regular session covered SED/DD reports, 2025 COC election reports, SDA Advisor appointments, NAP independent assessment, and the 2.5-hour policy/delegation review of 20 program areas. Follow-up on Feb 10 action items (ELAP federal-uniformity finding, CRP Signup 65 status, NW Colorado fence cost data) and Otero/Crowley COC continuity from March 17 special meeting.',
    detailedNotes: [
      {
        title: 'RESOLVED \u2014 ELAP State-by-State Differences (CO, WY, UT)',
        items: [
          'ANSWER: ELAP is a FEDERAL program administered uniformly nationwide under 7 CFR Part 1416, Subpart B. There are NO state-specific rules, payment rates, or day caps.',
          'The 150-day grazing loss cap (7 CFR 1416.110) applies equally in CO, WY, and UT. It is a regulatory cap set by USDA under delegated authority from the 2014 Farm Bill \u2014 not a number in the statute itself.',
          'Payment rates (updated by One Big Beautiful Bill Act, signed July 4, 2025): 75% for weather/disease losses; 100% for predation losses (new). Underserved producers (beginning/veteran/socially disadvantaged): 90%. All reduced by ~5.7% sequestration.',
          'NEW OBBBA provisions: Unborn livestock now covered (up to 85% of lowest weight class rate). Farm-raised fish bird depredation (min $600/acre). Honeybees: standardized 15% normal mortality threshold.',
          'State-level variation is ONLY in: (1) disaster designations determining WHEN producers become eligible, and (2) county-level normal grazing periods. For 2024+, FSA established 365-day grazing periods for perennial forages, reducing this variation.',
          'Colorado 2025 disaster designations: 30+ counties designated \u2014 April (12 counties incl. Logan, Weld, Larimer), May (6 incl. Mesa, Rio Blanco), June (7 incl. Fremont, Huerfano), August (3 incl. Moffat, Routt), September (Park, Summit)',
          'Wyoming 2025: 10 counties March (Albany, Carbon, Fremont, Park, etc.), Sweetwater County August (contiguous to CO Moffat and UT Daggett)',
          'Utah 2025: 3 counties September; also contiguous eligible from CO/WY designations (Daggett, Grand, San Juan, Uintah)',
          'Why not 365 days? The 150-day cap is a cost-control measure \u2014 ELAP was originally authorized at $20M/year from CCC funds. It is a gap-fill program for losses NOT covered by LFP or LIP, not intended as primary safety net for full grazing season.',
          'Kyle\u2019s recommendation: If STC believes 150 days is insufficient for Colorado, the path is a formal recommendation to FSA Administrator or congressional delegation. The cap is regulatory (USDA could change it) but budget constraints are the barrier.',
          'APPLICATION DEADLINE: Notice of loss within 30 days. Application + documentation by March 1 following program year. For 2025 losses: deadline was March 1, 2026 (already passed).',
          'Recent: USDA issued final ELRP payments (related program) totaling $1.89 billion for 2023\u20132024 drought/wildfire/flood losses (Feb 13, 2026).',
        ],
        link: { label: 'ELAP Program Page', url: 'https://www.fsa.usda.gov/resources/programs/emergency-assistance-livestock-honeybees-farm-raised-fish-elap' },
      },
      {
        ...
        items: [
          'Continuous CRP (CCRP): Signup opened Feb 12, 2026 \u2014 first batching period closed March 20, 2026 (first-come, first-served). Additional batching periods if acreage remains.',
          'General CRP Signup 65: Open March 9 \u2013 April 17, 2026 (competitive, ranked by Environmental Benefits Index). Accepted offers announced after ranking.',
          'Grassland CRP: 2026 signup dates NOT yet announced. 2025 Grassland signup ran July 7\u2013Aug 8.',
          'Acreage available: 1.9 million acres for FY2026. Of the 27M statutory cap, 25.8M acres are currently enrolled \u2014 enrollment will be highly competitive.',
          'Cap breakdown: ~7.8M acres General CRP (30%), ~8.3M acres Continuous (32%), ~9.7M acres Grassland (38%)',
          '2025 results: 2.6M acres offered, 1.78M accepted. Colorado was a top-3 state (with Kansas and South Dakota).',
          'Colorado: ~2.96 million acres enrolled, avg rental rate $23.77/acre (vs national avg $71.95/acre). 62,037 CO acres expiring FY2026; 17,736 in FY2027.',
          'IMPORTANT CHANGE: $13/acre minimum rental rate ELIMINATED \u2014 western county rates dropped to as low as $1/acre. CO Grassland CRP examples: Kiowa County max $11/acre, Cheyenne County max $13/acre.',
          'Rental rates now based on 75% of NASS cash rent data plus climate-smart practice incentive. FY2026 provisional county rates used 6 closest counties with NASS data.',
          'SE Colorado is a National Priority Area ("dust bowl" region) \u2014 qualifies for $5/acre bonus for Grassland CRP. Counties at/below $15/acre get 15 bonus EBI ranking points.',
          'Colorado-specific: CREP for Republican River Basin; SAFE LPC (Lesser Prairie Chicken)',
          'CRP authority extended ONLY through September 30, 2026 \u2014 without Farm Bill reauthorization, no new contracts after that date. One Big Beautiful Bill Act did NOT reauthorize CRP.',
          'FSA staffing losses (~17% since Jan 2025) may cause processing delays at county offices',
          'Under Secretary Fordyce: "We\u2019re still very close to the 27-million-acre statutory cap with 1.9 million acres available\u2026enrollment is likely to be competitive."',
        ],
        link: { label: 'CRP Program Page', url: 'https://www.fsa.usda.gov/resources/programs/conservation-programs/conservation-reserve-program' },
      },
      {
        ...
        items: [
          '4-strand barbed wire installed: ~$20,000/mile base ($3.79/ft). With gates, water gaps, and NW CO terrain: $25,000\u2013$32,000+/mile. Source: Colorado rancher Janie VanWinkle, NPR Oct 2025.',
          'Materials only: $15,000\u2013$20,000/mile ($2.84\u2013$3.79/ft). T-posts $7.50\u2013$13.50 each; wood posts $15\u2013$50; barbed wire rolls (1,320 ft) $60\u2013$160.',
          'Labor only: $0.50\u2013$1.75/ft nationally. NW CO likely higher due to remoteness. Turnkey contractors: $2.50\u2013$4.50/ft at ranch scale.',
          'HIGH-TENSILE ALTERNATIVE: $1.60\u2013$5.50/ft installed. 45% lower lifecycle cost than barbed wire. 30-year lifespan vs 15. Fewer posts (20\u201324 ft spacing vs 10\u201312). Lower maintenance and livestock injury risk.',
          'NRCS EQIP cost-share: 75% for standard producers, up to 90% for beginning/veteran/underserved. Practice Standard 382 (Fence). Advance payment: at least 50% up front for qualifying producers.',
          'ACTION: Download current CO EQIP payment schedule from NRCS Colorado before meeting. Contact NRCS field offices in Craig, Steamboat Springs, Meeker, or Walden for scenario-specific rates.',
          '2025 WILDFIRE IMPACT: Five major CO wildfires destroyed thousands of miles of ranch fencing. Reece Melton (Rio Blanco County) reported dozens of ranchers needing fencing aid. This has increased demand and wait times for contractors in NW CO.',
          'TARIFF IMPACT: 25% Section 232 steel tariffs remain in effect. New AD/CVD petitions on Chinese steel fencing (Jan 2025) with estimated dumping margins of 1,017\u20131,411%. Fencing companies announced price increases effective Aug 2025. Budget 10\u201315% above 2023 levels.',
          'BLM/USFS allotment fencing in NW CO has additional permitting requirements that add cost and timeline.',
          'Local contractors: TM Fencing (Grand County), First Rate Fence, Lovewell Fencing (Northern CO). CSU Extension offices in Routt/Moffat counties maintain contractor referral lists.',
        ],
        link: { label: 'NRCS Colorado Payment Schedules', url: 'https://www.nrcs.usda.gov/state-offices/colorado/payment-schedule' },
      },
      {
        ...
        items: [
          ...
          'CONFIRM: Letters signed by Chair Brown, delivered via email to all 5 COC members, and mailed via USPS with tracking (no signature required)',
          'CONFIRM: Signed/dated letter + tracking confirmation returned to Steve Niemann (Employee Relations, FPAC-FBC)',
          'CONFIRM: Reporting chain notified \u2014 Jerry Sonnenberg (CO SED), CC: Brandi May (ID), Kim Viers (MO), Rick Pinkston (DC)',
          'CONFIRM: CED formally notified of delegated authority for daily operations',
          'CONFIRM: Alisha Knapp letter file (0 KB issue) was resolved before delivery',
          'REINSTATEMENT: Per 7 CFR \u00a7 7.21, members\u2019 terms continue \u2014 admin leave does not terminate the term. No mandatory waiting period for reinstatement. STC should specify an effective date.',
          'MOTION NEEDED: Set effective date for COC to resume full authority under 7 CFR \u00a7 7.23 (program approvals, certifications, CED supervision)',
          'MOTION NEEDED: Rescind temporary CED delegation \u2014 clarify what reverts to COC (supervisory/approval/policy functions) vs. what CED retains (standard day-to-day operations)',
          'Per 7 CFR \u00a7 7.1(d): FSA Administrator retains authority to reverse or modify any STC determination \u2014 the cease-action does not preclude DC from taking a different position',
          'Per 7 CFR \u00a7 7.29: Deputy Administrator retains oversight of adverse personnel actions \u2014 ceasing action should be reported to Deputy Administrator\u2019s office',
          'DOCUMENTATION (7 CFR \u00a7 7.30): All STC records are federal records. March 24 minutes must cross-reference March 17 special meeting and include: vote counts, names of all 5 members, regulatory citations (7.1(d), 7.6, 7.28), rationale for ceasing action.',
          'NO PUBLIC NEWS FOUND \u2014 this matter has remained confidential as intended. No media coverage of Otero/Crowley COC administrative actions.',
        ],
    ...
    decisions: [
      ...
      'RULE ON: CRP enrollment strategy \u2014 Any STC guidance to county offices on General Signup 65 priorities?',
      'RULE ON: Fence cost data \u2014 Accept research or request local contractor quotes for specific projects?',
      'CONFIRM: Otero/Crowley letters delivered to all 5 members, CED notified, Niemann/Sonnenberg/DC reporting complete',
      'CONFIRM: Alisha Knapp letter file (0 KB) issue resolved before delivery',
      'MOTION: Set effective date for COC reinstatement and resumption of full authority',
      'MOTION: Rescind temporary CED delegation for supervisory/approval functions',
    ...
    researchLinks: [
      ...
      { label: 'ELAP General Fact Sheet 2025', url: 'https://www.fsa.usda.gov/sites/default/files/2025-06/FSA_ELAP_GeneralFactSheet_25e.pdf' },
      { label: 'ELAP Livestock Fact Sheet 2025', url: 'https://www.fsa.usda.gov/sites/default/files/2025-06/FSA_ELAP_Livestock_FactSheet_2025e.pdf' },
      { label: '7 CFR 1416 Subpart B \u2014 ELAP Regulations', url: 'https://www.ecfr.gov/current/title-7/subtitle-B/chapter-XIV/subchapter-B/part-1416/subpart-B' },
      { label: '7 CFR 1416.110 \u2014 Payment Calculations', url: 'https://www.law.cornell.edu/cfr/text/7/1416.110' },
      { label: 'OBBBA Agricultural Provisions (AFBF)', url: 'https://www.fb.org/market-intel/one-big-beautiful-bill-act-final-agricultural-provisions' },
      { label: 'ELRP Final Payments \u2014 $1.89B (Feb 2026)', url: 'https://www.fsa.usda.gov/news-events/news/02-13-2026/usda-issues-final-emergency-livestock-relief-program-payments-2023-2024' },
      { label: 'CO Disaster Designations (Aug 2025)', url: 'https://www.fsa.usda.gov/news-events/news/08-06-2025/usda-designates-3-colorado-counties-primary-natural-disaster-areas' },
      { label: 'CRP Program', url: 'https://www.fsa.usda.gov/resources/programs/conservation-programs/conservation-reserve-program' },
      { label: 'CRP 2026 Enrollment Announcement (Feb 10)', url: 'https://www.fsa.usda.gov/news-events/news/02-10-2026/usda-open-continuous-general-conservation-reserve-program-enrollment' },
      { label: 'CRP 2025 Results (1.78M acres)', url: 'https://www.fsa.usda.gov/news-events/news/09-17-2025/usda-accepts-nearly-18-million-acres-2025-conservation-reserve-program' },
      { label: 'CRP Statistics & County Reports', url: 'https://www.fsa.usda.gov/tools/informational/reports/conservation-statistics/crp' },
      ...
      { label: '7 CFR Part 7 \u2014 COC Regulations', url: 'https://www.ecfr.gov/current/title-7/subtitle-A/part-7' },
      { label: '7 CFR \u00a7 7.23 \u2014 COC Duties', url: 'https://www.law.cornell.edu/cfr/text/7/7.23' },
      { label: '7 CFR \u00a7 7.28 \u2014 Removal for Cause', url: 'https://www.ecfr.gov/current/title-7/subtitle-A/part-7/section-7.28' },
      { label: '7 CFR \u00a7 7.21 \u2014 Terms of Office', url: 'https://www.law.cornell.edu/cfr/text/7/7.21' },
      { label: 'FSA County Committee Elections', url: 'https://www.fsa.usda.gov/about-fsa/county-committee-elections' },
    ],
  },
  {
    monthKey: '2026-04',
    ...
    detailedNotes: [
      {
        title: 'Appeals Docket \u2014 see full briefs on /appeals',
        items: [
          'E1 / Ebright CRP \u2014 Bent County (carry-over from March 24, 90 min originally allocated). April 23 action: confirm written STC decision text, NAD right-to-appeal notice, and refund calculation if affirmed. Address dual-528-plan ambiguity on Contract 11117 and missing 528 page for Contract 11101 explicitly in the written record.',
          'E2 / Payne Legacy LLC CRP Payment Reduction Waiver \u2014 El Paso County (carry-over from March 24, 15 min). Final vote on standard-payment-reduction waiver. Apply same good-faith framework (2-CRP Par. 603A/D/E/F) used in Ebright for consistency.',
          'PLACEHOLDER \u2014 Confirm with Jon Weishaar / Corey Pelton whether any new CRP, NAP, LFP, ELAP, or Common Provisions appeals have been filed since March 24. Producers have 30 days from written COC decision to file (7 CFR 780.9).',
          'Reference \u2014 December 2025 Moffat County CRP equitable-relief grant is the nearest direct precedent for CRP appeals on this docket. Attach the written determination to the Appeals page record before citing.',
        ],
      },
      {
        title: 'CRP Cost Share Rates \u2014 Review & Vote',
        items: [
          'Hunter Cleveland prepared the 2026 CRP Cost Share Rate tables (50% cost share)',
          '49 total components: 4 retired, 2 new for 2026',
          'Key increases: water wells (+120\u2013370%), burning (+270%), fencing (+50\u2013100%)',
          'Tables available in Box and on /cost-share-rates',
          'STC to approve, modify, or reject each rate',
        ],
      },
      {
        title: 'EFRP Cost Share Rates \u2014 Review & Vote',
        items: [
      ...
      {
        title: 'Otero/Crowley COC Status',
        items: [
          'Status report on March 17 actions \u2014 cease administrative action, CED daily-operations delegation',
          'Confirm: 5 letters delivered & tracked (Knapp, Walter Jr, Hanagan, Tecklenburg, Mason)',
          'Confirm: Alisha Knapp 0-KB file resolved before delivery',
          'If members ready to resume: MOTION to set reinstatement effective date and clarify CED delegation rollback under 7 CFR \u00a7 7.23',
        ],
      },
      {
        title: 'FBA / Travel / Executive Director Report',
        items: [
          'Updated Colorado FBA payment figures \u2014 enrollment closed April 17',
    ...
    decisions: [
      'Appeals: confirm Ebright March 24 decision is documented in writing with all red flags addressed; confirm NAD notice delivered',
      'Appeals: record final vote on Payne Legacy LLC payment-reduction waiver',
      'Cost Share: vote on 2026 CRP cost share rate tables (Hunter Cleveland)',
      'Cost Share: vote on 2026 EFRP cost share rate tables (Hunter Cleveland)',
      'Otero/Crowley: confirm delivery of cease-action letters; set COC reinstatement timeline if members ready',
      'Confirm with State Office whether any new appeals have been docketed since March 24',
    ],
    researchLinks: [
      { label: 'Appeals Page \u2014 full docket & case briefs', url: '/appeals' },
      { label: 'Appeals Training (April 8) reference', url: '/appeals-training' },
      { label: 'Cost Share Rates', url: '/cost-share-rates' },
      { label: '7 CFR Part 780 \u2014 FSA Appeals', url: 'https://www.ecfr.gov/current/title-7/subtitle-A/part-780' },
      { label: '7 CFR Part 11 \u2014 NAD', url: 'https://www.ecfr.gov/current/title-7/subtitle-A/part-11' },
      { label: '2-CRP Handbook Par. 603 \u2014 Noncompliance & Good Faith', url: 'https://www.fsa.usda.gov/Internet/FSA_File/2-crp_r06_a00.pdf' },
    ],
  },
];
